...
import { createNewProject, createNewTask, deleteManagerProject, deleteProjectFile, getAllUsers, getProject, getProjectFilesController, managerProjects, updateExistedProject, updateTaskStatusById, uploadFileController } from "../controllers/manager/projects.manager.js";
...
router.route('/file/:fileId').delete(verifyUser,isManager,deleteProjectFile);
